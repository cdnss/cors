...
const $ = cheerio.load(htmlContent); // Parsing string HTML dengan Cheerio
              ...
              const finalResponse = new Response(htmlContent.replace("donate","ll").replace("onclick","data-on").replace("devtool","l").replace(/src="/g,'src="https://cloud.hownetwork.xyz').replace(".xyzjs",".xyz/js"), {
